...
export default function CalendarMemoryGameComp() {
  ...
  const renderCell = (
    ...
    let cellClasses = `font-courier group inline-flex items-center justify-center min-w-[140px] px-2.5 rounded text-[0.85rem] tracking-[0.04em] transition-all duration-[400ms] ease-in-out relative cursor-default border `;
