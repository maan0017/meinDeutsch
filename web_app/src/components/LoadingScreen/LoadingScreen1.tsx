...
export default function LoadingScreen1() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center gap-7 bg-background">
      ...
      <div className="flex flex-col items-center gap-1.5">
        ...
        <p className="text-sm text-foreground/60">Preparing your workspace…</p>
      </div>
      ...
      <div className="flex w-56 flex-col items-center gap-2.5">
        <div className="h-2.5 w-full overflow-hidden rounded-full bg-secondary/20">
          <div
            className="h-full rounded-full bg-foreground transition-all duration-75 ease-linear"
            style={{ width: `${progress}%` }}
          />
        </div>
        <span className="text-xs text-foreground/60">Loading fonts…</span>
      </div>
